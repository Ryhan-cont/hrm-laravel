<template>
    <div>
        ...
        <vx-card >
            <vs-table max-items="10" pagination search stripe :data="businessCards">

                <template slot="thead">
                    <vs-th sort-key="">Employee</vs-th>
                    <vs-th sort-key="">Card Amount</vs-th>
                ...
                <template slot-scope="{data}">
                    <vs-tr :key="indextr" v-for="(tr, indextr) in data" >
                        ...
                        <vs-td :data="tr.no_of_cards"> {{ tr.no_of_cards }} </vs-td>
        ...
        methods:{
            ...
            fetchReport(target) {
                axios.get("/api/report/business-card-report",{
                    ...
                    .then(response => {
                        this.businessCards = response.data.b_card_data;
            ...
            exportExcel(){
                ...
                window.open(`/export-business-card?${paramString.toString()}`);

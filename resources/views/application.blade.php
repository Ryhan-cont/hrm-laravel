...
<html lang="en">
  <head>
    ...
    <title>AgileX - HR Management System</title>
    <!-- Styles -->
  ...
  <body>
    <noscript>
      <strong>We're sorry but AgileX HR Management System doesn't work properly without JavaScript enabled. Please enable it to continue.</strong>
    </noscript>
    <div id="app"></div>

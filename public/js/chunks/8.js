...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    "warningZone": function warningZone() {
      if (this.warningZone) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    activeLink: function activeLink() {
      var result = !!((this.to === this.$route.path || this.$route.meta.parent === this.slug) && this.to);

      if (result == true) {
        this.$store.commit('UPDATE_MODULE_ID', this.moduleId);
      }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadNavMenuItems: function loadNavMenuItems() {
      var _this = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return axios.get('/api/data/layout');

              case 3:
                req = _context.sent;
                _this.navMenuItems = req.data.menu;
                userdata = {};
                ...
                userdata.isAdmin = req.data.user.roleid === _this.$constants.CONST_ROLE_COMPANY_ADMIN;
                userdata.photoURL = req.data.user.propic_url;

                _this.$store.commit('UPDATE_USER_INFO', userdata); //console.log(req);
  ...
  return _c(
    "svg",
    {
      attrs: {
        ...
        x: "0px",
        y: "0px",
        viewBox: "0 0 275.8 100",
        "enable-background": "new 0 0 275.8 100",
        "xml:space": "preserve"
      }
    },
    [
                    ...
                    _c(
                      "li",
                      {
                        ...
                        on: {
                          click: function($event) {
                            _vm.$router
                              .push("/profile/" + _vm.activeUserInfo.uid)
                              .catch(function() {})
                          }
                        }
                      },
      ...
      _c(
        ...
        [
          ...
          _c(
            "div",
            {
              staticClass: "content-wrapper vs-con-loading__container",
...
module.exports = "/images/logo.png?4070271050e8ee0a2965acb245a70d1e";

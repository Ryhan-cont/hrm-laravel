...
class Files
{
     ...
     * @throws \Exception
     */
    public function upload($image, $dir, $filename, $width = null, $height = 800, $crop = false)
    {
        ...
        $newName = $this->generateNewFileName($uploadedFile->getClientOriginalName(),$filename);
    ...
    public function generateNewFileName($currentFileName, $givenFileName)
    {
